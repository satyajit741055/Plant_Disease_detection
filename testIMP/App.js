...
const styles = StyleSheet.create({
  ...
  space: {marginVertical: 20, marginHorizontal: 20},
  labelText: {color: '#FFF', fontSize: 20, ...fonts.Bold,flex: 1, flexWrap: 'wrap' },
  resultText: {fontSize: 25, ...fonts.Bold},
  imageIcon: {height: 35, width: 35, tintColor: '#000'},
  emptyText: {
    position: 'absolute',
    top: height / 1.6,
    alignSelf: 'center',
